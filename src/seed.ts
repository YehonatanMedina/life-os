...
// ---------------------------------------------------------------------------
/**
 * שאלון הסקירה. core = השאלות שנפתחות מיד; השאר מאחורי "עוד שאלות",
 * כדי שסגירת שבוע תיקח חמש דקות ולא עשרים.
 */
export const REVIEW_QUESTIONS: Array<{ id: string; q: string; hint?: string; core?: boolean }> = [
  { id: 'q3', q: 'מה יצרתי השבוע שלא היה קיים לפניו?', core: true, hint: 'קובץ, טיוטה, הוכחה, מייל שנשלח. קריאה היא לא יצירה.' },
  { id: 'q1', q: 'מה נדחה השבוע, ולמה באמת?', core: true, hint: 'אם נדחו יותר מחמש — התוכנית לא ריאלית, לא אתה.' },
  { id: 'q4', q: 'מה החסם הבא בפועל, ומתי בדיוק אני מטפל בו?', core: true, hint: 'תאריך ושעה, לא "בקרוב".' },
  { id: 'q6', q: 'איך אני מרגיש פיזית ומנטלית?', core: true, hint: 'שינה, אוכל, כאבים, ראש. זה המדד שמתריע ראשון, לפני כל השאר.' },
  { id: 'q9', q: 'מה אני מוריד מהצלחת בשבוע הבא?', core: true, hint: 'להגיד לא זה חלק מהתוכנית, לא כישלון בה.' },
  { id: 'q2', q: 'כמה מהזמן שלי נחת על הנתיב הקריטי?', hint: 'תסתכל על "לאן הלך הזמן". שבוע מלא במסלול הלא נכון הוא שבוע אבוד.' },
  ...
  { id: 'q10', q: 'מה למדתי השבוע על איך אני עובד?', hint: 'לא על החומר — על עצמך. שעה ביום, סדר יום, מה שובר לך את הריכוז.' },
]
